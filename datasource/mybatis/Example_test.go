...
type ExampleActivityMapper struct {
	...
	SelectByIds2      func(ids []string) ([]Activity2, error) `mapperParams:"ids"`
	//SelectByIds2       func(ids []string) ([]map[string]string, error)       `mapperParams:"ids"`
...
func Test_inset(t *testing.T) {
	...
	//使用mapper
	var result, err = exampleActivityMapper.Insert(Activity{Id: "188", Name: "test_insret1", CreateTime: time.Now(), DeleteFlag: 1})
	if err != nil {
		panic(err)
	}
...
func Test_ForEach(t *testing.T) {
	...
	//使用mapper
	var ids = []string{"165", "166"}
	var result, err = exampleActivityMapper.SelectByIds2(ids)
	if err != nil {
		panic(err)
	}
	//var b, _ = json.Marshal(result)
