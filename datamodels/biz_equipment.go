...
type BizEquipment struct {
	ID              int     `json:"id" form:"id" gorm:"Column:ID"`
	Type            int     `json:"type" form:"type" gorm:"Column:TYPE"`
	Name            string  `json:"name" form:"name" gorm:"Column:NAME"`
	EqUrl           string  `json:"eqUrl" form:"eqUrl" gorm:"Column:EQ_URL"`
	EquipmentDetail string  `json:"equipmentDetail" form:"equipmentDetail" gorm:"Column:EQUIPMENT_DETAIL"`
